...
console.log('Bigger number between 3 and 5 is ',compareNums(3,5))
...
let sum = add('234ft',13)
console.log('Problem 6')
console.log('Sum of 234 and 13 is ',sum)
...
console.log(exclaimThree('problem8'))
...
function nameCheck(name){
  ...
  return (name == 'Bryan'? 'Hey Bryan!': `Cool name, ${name}`)
}
...
function faveColorFinder(color) {
  ...
  } return (color === 'black'? 'so trendy':'you need to evaluate your favorite color choice')
}
...
const bestMovie = (title) => {
  console.log(`${title} is the best movie ever!`)
}
bestMovie('Enchanto')
////////////////// PROBLEM 15 ////////////////////
...
//CODE HERE
function chocofrog(money) {
  return (Math.floor(money/3))
}
let totalFrogs = chocofrog(25)
...
let globalScope = ['sailor duck']

//This array should contain the variable names (as strings) accessible in the bathroom function.
let bathroomScope = ['shampoo', 'conditioner', 'soap']

//This array should contain the variable names (as strings) accessible in the bathtub function.
let bathtubScope = ['rubber duck']

//This array should contain the variable names (as strings) accessible in the pond function.
let pondScope = ['duck', 'frog']