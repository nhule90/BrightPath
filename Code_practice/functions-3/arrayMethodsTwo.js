...
// CODE HERE
console.log('Prob 1')
newNumber = numbers.forEach((elem) => console.log(elem / 2))
...
// CODE HERE
console.log('Prob 2')
numArr = numbers.map(function(elem){
  return elem/2
})  
console.log(numArr)
////////// PROBLEM 3 //////////
...
// CODE HERE
console.log('Prob 3')
newCities = cities.filter(function(elem){
  return elem.endsWith('i')
})
...
// CODE HERE
console.log('Prob 4')
newFruits = fruits.forEach(function(elem){
  if (elem.color == 'red'){
  ...
  } else {console.log(`The fruit with index ${fruits.indexOf(elem)} is neither apple or orange.`)}
})
...
// CODE HERE
console.log('Prob 5')
riceTotal = foods.filter(function(elem){
  return elem.name.includes('rice')
