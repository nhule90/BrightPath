...
function contains(arr,nam,cbfunc){
  cbfunc(arr.includes(nam))
}
...
function getUserById(arr,id,cbfunc){
  let obj = arr.find(ob => ob.id === id)
  return (obj == null? null:cbfunc(obj))
}
